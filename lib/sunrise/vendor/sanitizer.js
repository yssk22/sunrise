 ...
 */
html.makeHtmlSanitizer = function (elementDefs, sanitizeAttributes) {
  var stack;
  var ignoring;
...
function html_sanitize(htmlText, options){
  ...
  var out = [];
  var opt_uriPolicy = options.uriPolicy;
  var opt_nmTokenPoricy = options.nmTokenPoricy;
  var sanitizeAttribs = options.sanitizeAttribs || exports.defaultSanitizeAttribs;
  var elementDefs = options.elements || {};
  html.makeHtmlSanitizer(elementDefs, sanitizeAttribs)(htmlText, out);
  return out.join('');
}
