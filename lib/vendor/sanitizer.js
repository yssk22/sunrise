...
function html_sanitize(htmlText, options){
  ...
  var out = [];
  var opt_uriPolicy = options.uriPolicy || function(url) { if(/^https?:\/\//.test(url)) { return url }};
  var opt_nmTokenPolicy = options.nmTokenPoricy || function(id){ return id; };
  var sanitizeAttribs = options.sanitizeAttribs || exports.defaultSanitizeAttribs;
  var elementDefs = options.elements || {};

  html.makeHtmlSanitizer(elementDefs, function(tagname, attribs){
    return sanitizeAttribs(tagname, attribs, opt_uriPolicy, opt_nmTokenPolicy);
  })(htmlText, out);
  return out.join('');
}
...
exports.defaultSanitizeAttribs = sanitizeAttribs;

exports.EFLAGS = html4.eflags;
exports.ATYPES = html4.atypes;